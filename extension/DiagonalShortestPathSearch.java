 ...
 * Class: CS 231 B
 * Project: Project 7
 * Description: This program  defines the DiagonalShortestPathSearch
*/
import java.util.Comparator;

public class DiagonalShortestPathSearch extends AbstractMazeSearch {

    private PriorityQueue<Cell> priorityQueue;

    public DiagonalShortestPathSearch(Maze maze) {
        super(maze);
        Comparator<Cell> comparator = new Comparator<Cell>() {
            ...
            private int calculateCost(Cell cell) {
                ...
                if (cell.getPrev() != null) {
                    ...
                    if (dx1 != 0 && dy1 != 0) {
                        // Reduce the cost for diagonal movement
                        cost -= 2; // Adjust the cost for diagonal movement
                    }
                }
                return cost;
            }
