public class Exploration3 {
    public static void main(String[] args) {
        ...
        double avgCellsExploredShortestPath = conductShortestPathExperiment(mazeSize, obstacleDensity, totalTrials, display, delay);
        double avgCellsExploredDiagonalShortestPath = conductDiagonalShortestPathExperiment(mazeSize, obstacleDensity, totalTrials, display, delay);
        ...
        System.out.println("Average Cells Explored (Shortest Path): " + avgCellsExploredShortestPath);
        System.out.println("Average Cells Explored (Diagonal Shortest Path): " + avgCellsExploredDiagonalShortestPath);
    }
    ...
    private static double conductShortestPathExperiment(int mazeSize, double obstacleDensity, int totalTrials, boolean display, int delay) {
        int totalCellsExplored = 0;
        ...
        for (int i = 0; i < totalTrials; i++) {
            ...
            shortestPath.search(start, target, display, delay);
    ...
    private static double conductDiagonalShortestPathExperiment(int mazeSize, double obstacleDensity, int totalTrials, boolean display, int delay) {
        int totalCellsExplored = 0;
        ...
        for (int i = 0; i < totalTrials; i++) {
            ...
            diagonalShortestPath.shortest_search(start, target, display, delay);
